...
sleep 2
rm -f /mnt/d/codes/minimind/out/full_sft_h2_raft.log
rm -f /mnt/d/codes/minimind/out/full_sft_h2_raft_384_ple.pth
...
exec python3 -u train_full_sft.py \
    ...
    --save_weight full_sft_h2_raft --save_dir ../out \
    --save_interval 2000 --log_interval 100 \
    --dtype bfloat16 2>&1 | tee ../out/full_sft_h2_raft.log
