#!/bin/bash
# H1 RAFT 微调: 从 full_sft_h1 用 sft_medical_raft (8000条 证据+答案) 训练
...
sleep 2
rm -f /mnt/d/codes/minimind/out/full_sft_h1_raft.log
rm -f /mnt/d/codes/minimind/out/full_sft_h1_raft_256_ple.pth
rm -f /mnt/d/codes/minimind/checkpoints/full_sft_h1_raft_256_ple*.pth
...
exec python3 -u train_full_sft.py \
    ...
    --save_weight full_sft_h1_raft --save_dir ../out \
    --save_interval 2000 --log_interval 100 \
    --dtype bfloat16 2>&1 | tee ../out/full_sft_h1_raft.log
