# -*- coding: utf-8 -*-
"""H1 RAFT v4 问答验证 (负样本拒答/盲引修复)

用法: python scripts/eval_h1_raft_v4.py   (在仓库根目录, WSL GPU)
对照: wsl_eval_raft_v4.sh (H2 版) — 本文件为 H1 架构适配 (d256/l6/p96)
"""
import sys
import os
import math
...
m.load_state_dict(torch.load('out/full_sft_h1_raft_v4_256_ple.pth', map_location='cpu', weights_only=True), strict=True)
m = m.cuda().eval()
